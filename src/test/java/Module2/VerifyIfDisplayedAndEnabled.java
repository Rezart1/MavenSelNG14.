...
public class VerifyIfDisplayedAndEnabled {
    public static void main(String[] args) throws InterruptedException {
        ...
        boolean isFirstNameBoxEnabled = firstNameInput.isEnabled();
        System.out.println("First Name Input Box Is Enabled: " + isFirstNameBoxEnabled);
        ...
        // check if first name input box is enabled
        boolean isFirstNameBoxEnabledAfterEdit = firstNameInput.isEnabled();
        System.out.println("First Name Input Box Is Enabled: " + isFirstNameBoxEnabledAfterEdit);
        Thread.sleep(4000);
